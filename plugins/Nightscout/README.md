...
GlucoseBar CGM plugin for self-hosted [Nightscout](https://nightscout.github.io/) sites.

- **Identifier:** `nightscout`
- **Protocol:** [PLUGIN-PROTOCOL-V1](../../docs/plugins/PLUGIN-PROTOCOL-V1.md)

## Sign in (GlucoseBar Data Source)
...
Output: `plugins/Nightscout/dist/nightscout.glucoseplugin`

## Install into GlucoseBar

Drag **`dist/nightscout.glucoseplugin`** into **Settings → Plugins**.

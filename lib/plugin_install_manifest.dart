...
class PluginInstallManifest {
  ...
  static const String embeddedMagic = 'GLUCOBAR_PLUGIN_V1';
  static const String installXattrKey = 'com.glucosebar.plugin.install';
  ...
  static PluginInstallManifest? readEmbedded(File executable) {
    ...
    if (length < embeddedMagic.length + 4) {
      return null;
    }
    final magic = utf8.encode(embeddedMagic);
  ...
  static PluginInstallManifest? readXattr(String executablePath) {
    ...
    final result = Process.runSync('xattr', [
      '-p',
      installXattrKey,
      executablePath,
    ]);

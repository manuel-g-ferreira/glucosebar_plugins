...
Nightscout exposes a REST API on the user's site base URL. GlucoseBar reads **CGM entries** (`type: sgv`) only; treatments and profiles are out of scope for MVP.
...
GlucoseBar sign-in mapping:

| GlucoseBar field | Nightscout |
|------------------|------------|
| Username | Site URL |
...
- [MULTI-VENDOR-PLUGIN-DESIGN.md](MULTI-VENDOR-PLUGIN-DESIGN.md)

...
Out-of-process plugin (Node, Dart, or Go — TBD at implementation). Translates LibreLink Up HTTP API → GlucoseBar JSON line protocol. Host never calls Abbott directly.

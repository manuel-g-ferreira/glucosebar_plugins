...
description: ${options.displayName} CGM plugin for GlucoseBar (JSON line protocol v1).
publish_to: none
version: 0.1.0
...
GlucoseBar CGM plugin (`${options.identifier}`).
...
Drag `dist/${options.identifier}.glucoseplugin` into **Settings → Plugins**.

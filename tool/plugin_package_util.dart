...
import 'package:glucosebar_plugins/plugin_install_manifest.dart';
import 'package:glucosebar_plugins/plugin_package.dart';
import 'package:glucosebar_plugins/repository_root.dart';
import 'package:path/path.dart' as p;

import 'macos_codesign_util.dart';
import 'plugin_probe_util.dart';

/// Builds `dist/<id>.glucoseplugin` — one signed executable per platform.
Future<File> packagePluginForDistribution(Directory sourceRoot) async {
  ...
  final meta = await probePluginManifest(built.path);
